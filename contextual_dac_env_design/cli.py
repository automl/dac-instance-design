"""Console script for contextual_dac_env_design."""
...
from contextual_dac_env_design import cool_things
...
def main(cfg):
    ...
    with memray.Tracker("memray.bin"):
        ...
        print("     'python contextual_dac_env_design/cli.py +hello=world'")
